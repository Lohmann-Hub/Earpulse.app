...
Earpulse ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application Earpulse (the "App"). Please read this Privacy Policy carefully.

## Information We Collect

### Health Data
- **Heart Rate Data**: The App collects heart rate measurements from your AirPods Pro 3 biometric sensors
- **Activity Information**: Activity types you select during tracking sessions (e.g., sitting, walking, standing)
...
### Device Information
- Device model and iOS version (for app functionality and support purposes)
- App preferences (e.g., date format selection)

## How We Use Your Information

We use the information we collect to:
- Provide heart rate tracking and monitoring functionality
...
- HealthKit data is encrypted and managed by Apple
- You control HealthKit data access through iOS Settings
...
- Go to iOS Settings → Privacy → Health → Earpulse to manage permissions
...
By using the App, you consent to this Privacy Policy. If you do not agree with this Privacy Policy, please do not use the App.
